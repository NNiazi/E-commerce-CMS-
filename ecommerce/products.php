...
<div id="productsForSale">Products For Sale</div>
   <div id="content3">
            <div id="wrap">
                ...
                <?php
                    ...
                    if($products->count() > 0){
                        foreach ($products as $document) {
                            ...
                            echo '<figcaption>' . $document["description"] . "</figcaption>";
                            echo '<span class="price" style="color:black;">£' . $document["price"] . "</span>";
                            echo '<a class="button" class="btn add2cart" onclick=\'basket.add("' . $document["_id"] . '","' . $document["name"] . '","' . $document["description"] . '", "' . $document["price"] . '", 1)\'>';
...
<!---         Footer      -->
    ...
    <div class="footer">
      ...
      <div class="content2">
        ELARTE.COM<br>
        2018 Noman Niazi And Group All Rights Reserved
      </div>
    </div>
  </body>
</html>